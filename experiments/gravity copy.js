...
let elements = []; // Declare a variable to hold the elements
...
function setup() {
  ...
  for (let i = 0; i < 50; i++) {
    ...
    elements.push(new Element(x, y, randomColor));
  }

  attractor = new Attractor(innerWidth / 2, innerHeight / 2); // Initialize the attractor at the center of the canvas
  frameRate(40);
}
